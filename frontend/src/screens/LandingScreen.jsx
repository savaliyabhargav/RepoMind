...
WHERE depth <= 3`}</pre>
  ...
  repo, strategy="deep"
      ...
      <main className="landing-main">
        ...
        <section className="landing-hero-card">
          <div className="landing-copy">
            <span className="landing-kicker">Repository intelligence platform</span>
            <h1 className="landing-headline">
              Understand any codebase with
              <span className="headline-accent"> clean, high-signal analysis.</span>
            </h1>
            <p className="landing-sub">
              RepoMind turns GitHub repositories into structured insight with file mapping,
              architecture context, contributor patterns, and AI-assisted reasoning in one place.
            </p>
          ...
          <aside className="landing-sidecard" aria-label="Platform snapshot">
            <div className="sidecard-panel">
              <p className="sidecard-label">Current focus</p>
              <h2 className="sidecard-title">AI insight for your current repo stage</h2>
              <p className="sidecard-copy">
                Built to ingest, map, and surface structure without changing how your existing
                backend pipeline behaves.
              </p>
            </div>
      ...
      <footer className="landing-footer">
        <span>Copyright 2025 RepoMind</span>
