...
const AI_PROVIDER = "LOCAL"; // OpenAI-compatible local/Kaggle endpoints — failover happens server-side
        ...
        <>
                ...
                <>
                  <div className="ide-tabbar">
                    ...
                    <div className="ide-tabbar-actions">
                      <span className="ide-engine-chip" title="Diagrams are generated by a local/Kaggle Gemma model with automatic endpoint failover">
          ...
          <footer className="ide-statusbar">
            ...
            <div className="ide-status-group">
              ...
              <span className="ide-status-item ide-status-item--engine">Local</span>
