package com.repomind.analysis.domain;
...
public class Analysis {
    ...
    // Owned by repo-ingestion-service now — plain stored id, no cross-service FK.
    @Column(name = "repo_id", nullable = false)
    private UUID repoId;

    // Owned by auth-service now — plain stored id, no cross-service FK.
