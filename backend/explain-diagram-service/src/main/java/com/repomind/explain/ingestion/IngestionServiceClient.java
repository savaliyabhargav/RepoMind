package com.repomind.explain.ingestion;
...
/**
 * Repos/canonical-repos/file-nodes live in repo-ingestion-service's own
 * database — this client replaces the in-process RepoRepository/FileNodeRepository
 * reads that used to happen here.
 */
@Service
