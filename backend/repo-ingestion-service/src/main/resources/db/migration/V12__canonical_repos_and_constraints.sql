...
--    (the original migration also deduped pre-existing (user_id, url) rows against
--    the analyses table before adding this constraint — not needed here since
--    repo-ingestion-service starts from an empty database.)
ALTER TABLE repos
