package com.repomind.ingestion.kafka;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.repomind.ingestion.domain.CanonicalRepo;
import com.repomind.ingestion.domain.CanonicalRepoRepository;
import com.repomind.ingestion.domain.Repo;
import com.repomind.ingestion.domain.RepoRepository;
import com.repomind.ingestion.GitHubApiClient;
import com.repomind.ingestion.GitHubRateLimitException;
import com.repomind.ingestion.GitHubRateLimitTracker;
import com.repomind.ingestion.GitHubTransientException;
import com.repomind.ingestion.dto.GitHubRepoResponse;
import com.repomind.ingestion.dto.GitHubTreeEntry;
import com.repomind.ingestion.dto.GitHubTreeResponse;
...
class IngestionWorkerTest {
    ...
    void setUp() throws Exception {
        ...
        repo = Repo.builder().id(repoId).userId(userId).url(GITHUB_URL).status("PENDING").build();
